    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center min-h-[80vh]">
          ...
          {/* Centered Content */}
          <div className="text-center max-w-4xl animate-slide-in-left">
            <div className="relative">
              {/* Subtle background accent */}
              <div className="absolute -inset-8 bg-gradient-to-r from-white/95 via-white/90 to-white/95 rounded-3xl backdrop-blur-md border border-white/30 shadow-2xl -z-10 hover-glow"></div>
