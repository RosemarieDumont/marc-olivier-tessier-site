...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20 bg-[#003153]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-slide-up">
          <h2 className="text-4xl font-bold text-white mb-6 animate-slide-up stagger-1">Services</h2>
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed animate-slide-up stagger-2">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {Object.entries(services).map(([key, category]) => (
            <div key={key} className={`group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 hover-lift hover-glow animate-scale-in stagger-${Object.keys(services).indexOf(key) + 1}`}>
              {/* Header */}
              <div className="bg-[#14213D] p-6 text-white transition-all duration-300 group-hover:bg-[#003153]">
              ...
              <div className="p-6 relative z-10">
                {key === 'corporatif' && (
                  <p className="text-[#1F2937] text-sm mb-6 italic transition-colors duration-300 group-hover:text-[#1F2937]">
                ...
                <div className="space-y-4">
                  {category.services.map((service, index) => (
                    <div key={index} className="border-l-4 border-[#E6E6FA] pl-4 hover:border-[#003153] transition-all duration-300 py-2 hover:pl-6 hover:bg-[#E6E6FA]/30 rounded-r-lg">
                      <h4 className="font-semibold text-[#003153] mb-1 transition-colors duration-300 hover:text-[#14213D]">{service.name}</h4>
                      <p className="text-[#1F2937] text-sm transition-colors duration-300 hover:text-[#1F2937]">{service.description}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="mt-16 text-center animate-slide-up stagger-4">
          <div className="bg-[#14213D] rounded-2xl p-8 lg:p-12 shadow-xl hover-lift hover-glow transition-all duration-500">
            <div className="relative z-10">
              <h3 className="text-3xl font-bold text-white mb-4 animate-slide-up stagger-1">
                Prêt à sécuriser votre avenir financier ?
              </h3>
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto animate-slide-up stagger-2">
              ...
              <a className="animate-slide-up stagger-3"
                ...
                className="inline-flex items-center gap-3 bg-white text-[#003153] px-8 py-4 rounded-full font-semibold text-lg hover:bg-blue-50 transition-all duration-500 shadow-lg hover:shadow-2xl hover:-translate-y-2 hover-glow transform hover:scale-105"
              >
