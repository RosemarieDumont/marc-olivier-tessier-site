  ...
  return (
    <section id="bienvenue" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="bg-primary-dark rounded-2xl p-8 lg:p-12 text-white shadow-xl hover-lift hover-glow animate-slide-up stagger-2 transition-all duration-500">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative z-10 animate-slide-in-left stagger-1">
                <h3 className="text-3xl font-bold mb-6 flex items-center gap-3 animate-slide-up stagger-1">
                  <div className="p-2 bg-primary-700 rounded-lg transition-transform duration-300 hover:scale-110">
                    <User className="w-6 h-6 text-white" />
                  </div>
                  Marc-Olivier Tessier
                </h3>
                <div className="space-y-4 text-primary-100 leading-relaxed text-lg animate-slide-up stagger-2">
                  <p>
